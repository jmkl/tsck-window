...
const WM_SET_FOCUS_BORDER: u32 = WM_USER + 1;

fn create_render_target(hwnd: HWND, w: i32, h: i32) -> Result<(ID2D1HwndRenderTarget)> {
...
impl BorderPainter {
    pub fn new(id: &str) -> Result<Self> {
        ...
        let class_name = format!("BorderOverlay{}\0", id);
...
impl Drop for BorderPainter {
    fn drop(&mut self) {
        println!("BorderPainter Dropped");
        unsafe {
